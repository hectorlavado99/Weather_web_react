...
describe('FormCity request', () => {
    it('returns data when searchCity is called', done => {
        ...
        mock.onGet(`http://dataservice.accuweather.com/locations/v1/cities/autocomplete?apikey=${apiKey}&q=${city}&language=es-es`).reply(200,cities);
...
describe('SearchDay request', () => {
    it('returns data when searchDay is called', done => {
        ...
        MobileLink:"http://m.accuweather.com/es/es/barcelona/307297/daily-weather-forecast/307297?day=1&unit=c",
        Link:"http://www.accuweather.com/es/es/barcelona/307297/daily-weather-forecast/307297?day=1&unit=c"},   
        ...
        MobileLink:"http://m.accuweather.com/es/es/barcelona/307297/daily-weather-forecast/307297?day=2&unit=c",
        Link:"http://www.accuweather.com/es/es/barcelona/307297/daily-weather-forecast/307297?day=2&unit=c"},
        ...
        MobileLink:"http://m.accuweather.com/es/es/barcelona/307297/daily-weather-forecast/307297?day=3&unit=c",
        Link:"http://www.accuweather.com/es/es/barcelona/307297/daily-weather-forecast/307297?day=3&unit=c"},
        ...
        MobileLink:"http://m.accuweather.com/es/es/barcelona/307297/daily-weather-forecast/307297?day=4&unit=c",
        Link:"http://www.accuweather.com/es/es/barcelona/307297/daily-weather-forecast/307297?day=4&unit=c"}
    ]

        var cityKey ="307297";
        var apiKey =localStorage.getItem('apiKey');
        mock.onGet(`http://dataservice.accuweather.com/forecasts/v1/daily/5day/${cityKey}?apikey=${apiKey}&language=es-es&metric=true`).reply(200, weatherDay);
...
describe('SearchHour request', () => {
    it('returns data when searchHour is called', done => {
        ...
        MobileLink: "http://m.accuweather.com/es/es/barcelona/307297/hourly-weather-forecast/307297?day=1&hbhhour=14&unit=c",
        Link:"http://www.accuweather.com/es/es/barcelona/307297/hourly-weather-forecast/307297?day=1&hbhhour=14&unit=c"}   
        ...
        MobileLink: "http://m.accuweather.com/es/es/barcelona/307297/hourly-weather-forecast/307297?day=1&hbhhour=15&unit=c",
        Link:"http://www.accuweather.com/es/es/barcelona/307297/hourly-weather-forecast/307297?day=1&hbhhour=15&unit=c"}
        ...
        MobileLink: "http://m.accuweather.com/es/es/barcelona/307297/hourly-weather-forecast/307297?day=1&hbhhour=16&unit=c",
        Link:"http://www.accuweather.com/es/es/barcelona/307297/hourly-weather-forecast/307297?day=1&hbhhour=16&unit=c"}
        ...
        MobileLink: "http://m.accuweather.com/es/es/barcelona/307297/hourly-weather-forecast/307297?day=1&hbhhour=17&unit=c",
        Link:"http://www.accuweather.com/es/es/barcelona/307297/hourly-weather-forecast/307297?day=1&hbhhour=17&unit=c"}]

        var cityKey ="307297";
        var apiKey =localStorage.getItem('apiKey');
        mock.onGet(`http://dataservice.accuweather.com/forecasts/v1/hourly/12hour/${cityKey}?apikey=${apiKey}&language=es-es&metric=true`).reply(200, weatherHour);
